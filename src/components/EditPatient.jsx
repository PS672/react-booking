...
const handlePayNowClick=()=>{
    ...
    const onSubmit=async(e)=>{
        ...
        await axios.put(`http://localhost:9192/api/ahospital/${id}`,user);
        navigate(`/patientviewdetails/${userEmail}`);    
    }


const loadUser =async()=>{
    const result=await axios.get(`http://localhost:9192/api/ahospital/${id}`)
    setUser(result.data)
}
        ...
        <div className="book-process">
              ...
              <form className="book-form" >
               ...
               onChange={(e) => onInputChange(e)}><br></br>
                ...
                <button className="payment-btn" type="submit" onClick={handlePayNowClick} >cancel</button>
